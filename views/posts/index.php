<div id="content">
		...
		foreach ($user_posts as $row) { ?>
			<div class="msg">
				...
				<p><?php echo $row['message']; ?><span class="name">（<?php echo $row['name']; ?>）</span>[<a href="index.html?res=1">Re</a>]</p>
				<p class="day">
					<a href="show/<?php echo $row['id']; ?>">2015-10-10 12:00:00</a>
					<a href="view.html">返信元のメッセージ</a>
					[<a href="destroy/<?php echo $row['id']; ?>" style="color: #F33;">削除</a>]
				</p>
